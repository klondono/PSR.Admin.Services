...
namespace PublicServiceRequest.Admin.DAL.Models
{
    public class BaseDbContext : DbContext
    {
        ...
        public override int SaveChanges()
        {
            ...
            string strUserDomainName = "";

            var userName = this.UserName;
            if (!String.IsNullOrEmpty(userName))
            {
                guidUserID = IdentityHelper.GetUserID(userName);
                strUserFullName = IdentityHelper.GetFullName(userName);
                strUserDomainName = $"MIAMIDADE\\{userName}";
            }
            else
            {
                guidUserID = IdentityHelper.GetUserID(HttpContext.Current.User.Identity);
                strUserFullName = IdentityHelper.GetFullName(HttpContext.Current.User.Identity);
                strUserDomainName = HttpContext.Current.User.Identity.Name;
            }
