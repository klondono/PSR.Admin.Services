...
{
    public class RequestPrioritiesController : BaseODataController
    {
        private readonly RequestPriorityBLL _requestPriorityBLL;
        public RequestPrioritiesController(RequestPriorityBLL requestPriorityBLL)
        {
            if (requestPriorityBLL != null)
            {
                _requestPriorityBLL = requestPriorityBLL;
            }
            else
            {
                throw new ArgumentNullException("RequestPriorityBLL is null.");
            }
        }
        ...
        {
            return _requestPriorityBLL.GetRequestPriorities();
        }
        ...
        {
            return SingleResult.Create(_requestPriorityBLL.Find(key));
        }
