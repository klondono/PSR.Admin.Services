...
{
    public class CustomFieldSelectListItemsController : BaseODataController
    {
        private readonly CustomFieldSelectListItemBLL _customFieldSelectListItemBLL;
        public CustomFieldSelectListItemsController(CustomFieldSelectListItemBLL customFieldSelectListItemBLL)
        {
            if (customFieldSelectListItemBLL != null)
            {
                _customFieldSelectListItemBLL = customFieldSelectListItemBLL;
            }
            else
            {
                throw new ArgumentNullException("CustomFieldSelectListItemBLL is null.");
            }
        }
        ...
        {
            return _customFieldSelectListItemBLL.GetCustomFieldSelectListItems();
        }
        ...
        {
            return SingleResult.Create(_customFieldSelectListItemBLL.Find(key));
        }
