...
{
    public class ServiceTypeSearchKeywordLinksController : BaseODataController
    {
        private readonly ServiceTypeSearchKeywordLinkBLL _serviceTypeSearchKeywordLinkBLL;
        public ServiceTypeSearchKeywordLinksController(ServiceTypeSearchKeywordLinkBLL serviceTypeSearchKeywordLinkBLL)
        {
            if (serviceTypeSearchKeywordLinkBLL != null)
            {
                _serviceTypeSearchKeywordLinkBLL = serviceTypeSearchKeywordLinkBLL;
            }
            else
            {
                throw new ArgumentNullException("ServiceTypeSearchKeywordLinkBLL is null.");
            }
        }
        ...
        {
            return _serviceTypeSearchKeywordLinkBLL.GetServiceTypeSearchKeywordLinks();
        }
        ...
        {
            return SingleResult.Create(_serviceTypeSearchKeywordLinkBLL.Find(key));
        }
