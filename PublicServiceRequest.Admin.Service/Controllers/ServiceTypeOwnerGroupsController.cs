...
{
    public class ServiceTypeOwnerGroupsController : BaseODataController
    {
        private readonly ServiceTypeOwnerGroupBLL _serviceTypeOwnerGroupBLL;
        public ServiceTypeOwnerGroupsController(ServiceTypeOwnerGroupBLL serviceTypeOwnerGroupBLL)
        {
            if (serviceTypeOwnerGroupBLL != null)
            {
                _serviceTypeOwnerGroupBLL = serviceTypeOwnerGroupBLL;
            }
            else
            {
        ...
        {
            return _serviceTypeOwnerGroupBLL.GetServiceTypeOwnerGroups();
        }
        ...
        {
            return SingleResult.Create(_serviceTypeOwnerGroupBLL.Find(key));
        }
