...
{
    public class AttachmentTypesController : BaseODataController
    {
        private readonly AttachmentTypeBLL _attachmentTypeBLL;
        public AttachmentTypesController(AttachmentTypeBLL attachmentTypeBLL)
        {
            if (attachmentTypeBLL != null)
            {
                _attachmentTypeBLL = attachmentTypeBLL;
            }
            else
            {
                throw new ArgumentNullException("AttachmentTypeBLL is null.");
            }
        }
        ...
        {
            return _attachmentTypeBLL.GetAttachmentTypes();
        }
        ...
        {
            return SingleResult.Create(_attachmentTypeBLL.Find(key));
        }
