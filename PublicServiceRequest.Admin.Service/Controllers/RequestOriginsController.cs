...
{
    public class RequestOriginsController : BaseODataController
    {
        private readonly RequestOriginBLL _requestOriginBLL;
        public RequestOriginsController(RequestOriginBLL requestOriginBLL)
        {
            if (requestOriginBLL != null)
            {
                _requestOriginBLL = requestOriginBLL;
            }
            else
            {
                throw new ArgumentNullException("RequestOriginBLL is null.");
            }
        }
        ...
        {
            return _requestOriginBLL.GetRequestOrigins();
        }
        ...
        {
            return SingleResult.Create(_requestOriginBLL.Find(key));
        }
