...
{
    public class CustomFieldTypesController : BaseODataController
    {
        private readonly CustomFieldTypeBLL _customFieldTypeBLL;
        public CustomFieldTypesController(CustomFieldTypeBLL customFieldTypeBLL)
        {
            if (customFieldTypeBLL != null)
            {
                _customFieldTypeBLL = customFieldTypeBLL;
            }
            else
            {
                throw new ArgumentNullException("CustomFieldTypeBLL is null.");
            }
        }
        ...
        {
            return _customFieldTypeBLL.GetCustomFieldTypes();
        }
        ...
        {
            return SingleResult.Create(_customFieldTypeBLL.Find(key));
        }
