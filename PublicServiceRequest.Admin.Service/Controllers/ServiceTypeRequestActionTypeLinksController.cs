...
{
    public class ServiceTypeRequestActionTypeLinksController : BaseODataController
    {
        private readonly ServiceTypeRequestActionTypeLinkBLL _serviceTypeRequestActionTypeLinkBLL;
        public ServiceTypeRequestActionTypeLinksController(ServiceTypeRequestActionTypeLinkBLL serviceTypeRequestActionTypeLinkBLL)
        {
            if (serviceTypeRequestActionTypeLinkBLL != null)
            {
                _serviceTypeRequestActionTypeLinkBLL = serviceTypeRequestActionTypeLinkBLL;
            }
            else
            {
                throw new ArgumentNullException("ServiceTypeRequestActionTypeLinkBLL is null.");
            }
        }

        // GET: odata/ServiceTypeRequestActionTypeLinks
        [EnableQuery(MaxExpansionDepth = 5)]
        public IQueryable<ServiceTypeRequestActionTypeLink> GetServiceTypeRequestActionTypeLinks()
        {
            return _serviceTypeRequestActionTypeLinkBLL.GetServiceTypeRequestActionTypeLinks();
        }

        // GET: odata/ServiceTypeRequestActionTypeLinks(5)
        [EnableQuery]
        public SingleResult<ServiceTypeRequestActionTypeLink> GetServiceTypeRequestActionTypeLink([FromODataUri] int? key)
        {
            return SingleResult.Create(_serviceTypeRequestActionTypeLinkBLL.Find(key));
        }
        ...
        public IHttpActionResult AddOrUpdate(ODataActionParameters parameters)
        {
            ...
            IQueryable<ServiceTypeRequestActionTypeLink> returnedEntity = null;
            ServiceTypeActionTypeLinkContainerModel containerModel = (ServiceTypeActionTypeLinkContainerModel)parameters["serviceTypeActionTypeLinkContainerModel"];

            try
            {
                returnedEntity = _serviceTypeRequestActionTypeLinkBLL.UpdateActionTypesForServiceType(containerModel);
            }
